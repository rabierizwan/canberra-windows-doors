...
type SignatureProductProps = {
  product: Product;
  /** Optional body paragraph that overrides product.intro[0] for the home feature */
  body?: string;
  /** Optional override for the call-to-action link text */
  ctaLabel?: string;
};
